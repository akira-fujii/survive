...
【重要：年数のインフレ（指数関数的成長）】
- 最初は現実的な年数から始まり、徐々に指数関数的にインフレしていきます。
- 購入履歴の数に応じた年数の目安（厳守）:
  - 1個目: 1〜5年（現実的。趣味を始めたばかり）
  - 2個目: 5〜20年（少し慣れてきた）
  - 3個目: 20〜100年（組み合わせの発見）
  - 4個目: 100〜1,000年（シナジーが生まれ始める）
  - 5個目: 1,000〜10,000年（効率化が進む）
  - 6個目: 1万〜10万年（習熟の境地）
  - 7個目: 10万〜100万年（悟りの領域）
  - 8個目: 100万〜1,000万年（超越的な時間感覚）
  - 9個目以降: 1,000万年〜（シナジー次第で爆発的に）
- この目安を基本とし、シナジーが良ければ上限寄り、悪ければ下限寄りにしてください。
- 序盤で数万年以上を出すのは禁止です。段階的な成長を大切にしてください。
